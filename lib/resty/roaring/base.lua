-- This code is auto generated should only changed by ffi_utils @2020-10-19 16:12:41
local cdef = [[
...
---@param bytes string @ char
---@return any @ void 
function _M:r32_add_bytes(bytes)
	return self.libc.r32_add_bytes(self.cdata, bytes)
end
