-- This code is auto generated should only changed by ffi_utils @2020-05-05 21:11:41
local cdef =
[[
...
void *r64_bitmapOf(Roaring64Map *self, int64_t n1, int64_t n2,
                              int64_t n3, int64_t n4, int64_t n5, int64_t n6,
                              int64_t n7, int64_t n8, int64_t n9, int64_t n10);
void *r32_bitmapOf(Roaring *self, int64_t n1, int64_t n2, int64_t n3,
                              int64_t n4, int64_t n5, int64_t n6, int64_t n7,
                              int64_t n8, int64_t n9, int64_t n10);
...
void r64_addMany(Roaring64Map *self, size_t n_args,
                            const size_t *vals);
void r32_addMany(Roaring *self, size_t n_args,
                            const uint32_t *vals);
...
uint64_t r64_add_hash(Roaring64Map *self, const char *uid,
                                int length);
...
uint64_t r64_xxhash64(const char *str, size_t length, uint64_t seed,
                                 char *dst_8bytes);
uint32_t r64_xxhash32(const char *str, size_t length,
                                 uint64_t seed);
]]

---@class resty.roaring.base
local _M = {
    _source = "/code/CRoaring/luac.cpp",
    cdef = cdef
}
